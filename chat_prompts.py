...
chat_prompts['chatgpt-an-enfj-reverse']['system_message'] = '''You can only reply to me numbers from 1 to 5. Score each statement on a scale of 1 to 5, with 1 being disagree and 5 being agree.'''
